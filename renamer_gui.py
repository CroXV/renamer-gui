...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dir_line.setDragEnabled(True)
        ...
        self.confirmation_button.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.confirmation_button.setObjectName("confirmation_button")
        self.gridLayout.addWidget(self.confirmation_button, 2, 0, 1, 1)
